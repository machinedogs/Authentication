...
Rails.application.routes.draw do
  scope '/rails/action_mailbox', module: 'action_mailbox/ingresses' do
    post '/postmark/inbound_emails' => 'postmark/inbound_emails#create',
         as: :rails_postmark_inbound_emails
    post '/relay/inbound_emails' => 'relay/inbound_emails#create',
         as: :rails_relay_inbound_emails
    post '/sendgrid/inbound_emails' => 'sendgrid/inbound_emails#create',
         as: :rails_sendgrid_inbound_emails
  ...
  scope 'rails/conductor/action_mailbox/',
        module: 'rails/conductor/action_mailbox' do
    resources :inbound_emails, as: :rails_conductor_inbound_emails
    post ':inbound_email_id/reroute' => 'reroutes#create',
         as: :rails_conductor_inbound_email_reroute
  end
end
